 ...
 * @date 2016年9月20日
 */
public class AccountWorthSearchService implements Serializable {
    ...
    public DataFrame getUserBehaviorClueDF(HiveContext sqlContext, String appids) {
    	...
    	String paramSql = " AND ((EVENT='投连产品' AND (SUBTYPE='投连账户价值查询1' or SUBTYPE='投连账户价值查询2' or SUBTYPE='投连账户盈亏查询'))"
    					+ " OR (EVENT='万能产品' AND SUBTYPE='万能账户查询')"
    					+ " OR (EVENT='幸福晚年（养老金）产品' AND (SUBTYPE='幸福晚年（养老金）查询' OR SUBTYPE='幸福晚年（养老金）查询-详细查询')))";
