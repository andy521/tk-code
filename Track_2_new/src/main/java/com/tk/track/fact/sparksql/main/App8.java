...
public class App8 {
	...
	public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("Taikang Track FACT_USER_BEHAVIOR_TELE_SYSTEM ETL APP8");
        ...
        String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "system.callSkill");
        App.loadCallSkillStatisticsEvent(sqlContext, appids);
		App.loadNetTeleCallSkill(sqlContext, appids);
