...
public class App32 {
	...
	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("Taikang Track FACT_USER_BEHAVIOR_TELE_WECHAT ETL APP32");
		...
		App.newLoadFactUserBehaviorTeleWechatHot(sqlContext, appids);
