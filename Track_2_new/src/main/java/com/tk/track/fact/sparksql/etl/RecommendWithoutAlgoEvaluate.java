 ...
 */
public class RecommendWithoutAlgoEvaluate implements Serializable {
...
//		return DataFrameUtil.getDataFrame(sqlContext, sql, "FactHealthcreditscoreResultUserIdNotNullDF", DataFrameUtil.CACHETABLE_PARQUET);
     ...
     * @return
     */
    private DataFrame getUsedPolicyNo(HiveContext sqlContext,String srcTable, String srcTable1){
        String sql="select  lia_policyno  from "+srcTable+" group by lia_policyno" +
                " union all" +
                " select  lia_policyno  from "+srcTable1+" group by lia_policyno";
    ...
    private DataFrame mergeAndGroupByProduct(HiveContext sqlContext,String tableName1,String tableName2,String destName){
        ...
        String sql="select b.lrt_id,b.is_recomend,b.product_name,b.click_day,b.info_type," +
                ...
                "and p.is_recomend=b.is_recomend ";
        return DataFrameUtil.getDataFrame(sqlContext, sql, destName);
    }
...
//        saveAsParquet(sumP,"/user/tkonline/taikangtrack_test/data/recomden_evalute_SumUserVaildPolicy");
        ...
        //微信端保单关联推荐浏览记录并去重
        getPlatformByFromId(sqlContext,"SumUserVaildPolicy","微信","WxSumUserVaildPolicy");
        DataFrame wxdf=getUserPolicyConnectBrowser(sqlContext,"WxSumUserVaildPolicy","RecommendCommonUserPageVisit","WxUserPolicyConnectBrowser","0");
//        saveAsParquet(wxdf,"/user/tkonline/taikangtrack_test/data/recomden_evalute_upcb_wx");
        DataFrame wxdf1=getEarliestAsResult(sqlContext,"WxUserPolicyConnectBrowser","WxEarliestPolicyResult","是");
//        saveAsParquet(wxdf1,"/user/tkonline/taikangtrack_test/data/recomden_evalute_ear_wxdf1");
        
        //WAP保单关联推荐浏览记录
        getPlatformByFromId(sqlContext,"SumUserVaildPolicy","WAP","WapSumUserVaildPolicy");
        DataFrame wapdf=getUserPolicyConnectBrowser(sqlContext,"WapSumUserVaildPolicy","RecommendCommonUserPageVisit","WapUserPolicyConnectBrowser","1");
//        saveAsParquet(wapdf,"/user/tkonline/taikangtrack_test/data/recomden_evalute_upcb_wap");
        DataFrame wapdf1=getEarliestAsResult(sqlContext,"WapUserPolicyConnectBrowser","WapEarliestPolicyResult","是");
//        saveAsParquet(wapdf1,"/user/tkonline/taikangtrack_test/data/recomden_evalute_ear_wapdf1");
        
        //PC保单关联推荐浏览记录
        getPlatformByFromId(sqlContext,"SumUserVaildPolicy","PC","PCSumUserVaildPolicy");
        DataFrame pcdf=getUserPolicyConnectBrowser(sqlContext,"PCSumUserVaildPolicy","RecommendCommonUserPageVisit","PCUserPolicyConnectBrowser","2");
//        saveAsParquet(pcdf,"/user/tkonline/taikangtrack_test/data/recomden_evalute_upcb_pc");
        //PC端保单去重
        DataFrame pcdf1=getEarliestAsResult(sqlContext,"PCUserPolicyConnectBrowser","PCEarliestPolicyResult","是");
//        saveAsParquet(pcdf1,"/user/tkonline/taikangtrack_test/data/recomden_evalute_ear_pcdf1");
        
        //APP保单关联推荐浏览记录
        getPlatformByFromId(sqlContext,"SumUserVaildPolicy","APP","APPSumUserVaildPolicy");
//        DataFrame appdf=getUserPolicyConnectBrowser(sqlContext,"APPSumUserVaildPolicy","RecommendCommonUserPageVisit","APPUserPolicyConnectBrowser","3");

        //合并去重的三端保单
        DataFrame dfAll = getAllEarliestAsResult(sqlContext, "WxEarliestPolicyResult", "WapEarliestPolicyResult", "PCEarliestPolicyResult", "EarliestPolicyResult");
//        saveAsParquet(dfAll,"/user/tkonline/taikangtrack_test/data/recomden_evalute_ear_all");
//      
        //全部浏览记录关联全部保单和去重，为了找出非自由平台的from_id
        DataFrame summeryDF = getSummeryUserPolicyConnectBrowser(sqlContext, "SumUserVaildPolicy", "RecommendCommonUserPageVisit", "UserPolicyConnectBrowser_new_temp");
//        saveAsParquet(summeryDF,"/user/tkonline/taikangtrack_test/data/UserPolicyConnectBrowser_new_temp");
        DataFrame summeryDF1 = getEarliestAsResult(sqlContext, "UserPolicyConnectBrowser_new_temp", "SummeryEarliestPolicyResult", "是");
//        saveAsParquet(summeryDF1,"/user/tkonline/taikangtrack_test/data/SummeryEarliestPolicyResult");
        
        String sysDate = GetSysDate(0);
        //添加from_id后，流失的数据 daother
        DataFrame otherDF= getAllOtherPolicyByFromId(sqlContext, "allFindRecomendPolicyByFromId");
//        saveAsParquet(otherDF,"/user/tkonline/taikangtrack/data/allfindrecomendpolicy_byfromid");
...
//       saveAsParquet(dfNonRemmendAll,"/user/tkonline/taikangtrack_test/data/non_recomend_all");
        ...
        //找到推荐保单
        getUsedPolicyNo(sqlContext,"EarliestPolicyResult","allFindRecomendPolicyByFromIdOnce");
        //总表单减去推荐保单，剩下的就是非推荐的保单
        getNonUsedPolicyNo(sqlContext);
        //微信端非推荐保单关联记录和去重
        getPlatformByFromId(sqlContext,"NonUsedPolicyNo","微信","WxNonUsedPolicyNo");
        DataFrame df2221=getUserPolicyConnectBrowser(sqlContext,"WxNonUsedPolicyNo","NonRecommendCommonUserPageVisit","WxNonUserPolicyConnectBrowser","0");
//        saveAsParquet(df2221,"/user/tkonline/taikangtrack_test/data/recomden_evalute_upcb_wxnon");
        getEarliestAsResult(sqlContext,"WxNonUserPolicyConnectBrowser","WxNonEarliestAsResult","否"); 
        
        //WAP端非推荐保单关联记录和去重
        getPlatformByFromId(sqlContext,"NonUsedPolicyNo","WAP","WAPNonUsedPolicyNo");
        DataFrame df2222=getUserPolicyConnectBrowser(sqlContext,"WAPNonUsedPolicyNo","NonRecommendCommonUserPageVisit","WapNonUserPolicyConnectBrowser","1");
//        saveAsParquet(df2222,"/user/tkonline/taikangtrack_test/data/recomden_evalute_upcb_wapnon");
        getEarliestAsResult(sqlContext,"WapNonUserPolicyConnectBrowser","WAPNonEarliestAsResult","否");
        
        //PC端非推荐保单关联记录和去重
        getPlatformByFromId(sqlContext,"NonUsedPolicyNo","PC","PCNonUsedPolicyNo");
        DataFrame df2223=getUserPolicyConnectBrowser(sqlContext,"PCNonUsedPolicyNo","NonRecommendCommonUserPageVisit","PCNonUserPolicyConnectBrowser","2");
//        saveAsParquet(df2223,"/user/tkonline/taikangtrack_test/data/recomden_evalute_upcb_pcnon");
        getEarliestAsResult(sqlContext,"PCNonUserPolicyConnectBrowser","PCNonEarliestAsResult","否");
        
        //合并三段去重保单
        DataFrame dfAllno = getAllEarliestAsResult(sqlContext, "WxNonEarliestAsResult", "WAPNonEarliestAsResult", "PCNonEarliestAsResult", "NonEarliestPolicyResult");
//        saveAsParquet(dfAllno,"/user/tkonline/taikangtrack_test/data/recomden_evalute_ear_non");
        
        //没加from_id时，非推荐的保单和去重
        DataFrame summeryDF2 = getSummeryUserPolicyConnectBrowser(sqlContext, "NonUsedPolicyNo", "NonRecommendCommonUserPageVisit", "NonUserPolicyConnectBrowser_new_temp");
//        saveAsParquet(summeryDF2,"/user/tkonline/taikangtrack_test/data/NonUserPolicyConnectBrowser_new_temp");
        DataFrame summeryDF3 = getEarliestAsResult(sqlContext, "NonUserPolicyConnectBrowser_new_temp", "SummeryNonEarliestPolicyResult", "否");
//        saveAsParquet(summeryDF3,"/user/tkonline/taikangtrack_test/data/SummeryNonEarliestPolicyResult");
        
        //获取加from_id后，非推荐减少的保单nodaother
        DataFrame otherDF4= getAllOtherNonPolicyByFromId(sqlContext, "allFindNonRecomendPolicyByFromId");
//        saveAsParquet(otherDF4,"/user/tkonline/taikangtrack/data/allfindnonrecomendpolicy_byfromid");

        //合并daother和nodaother的保单
        DataFrame mPB=MergeOthereRecomendAndNonRecomendUP(sqlContext);
//        saveAsParquet(mPB,"/user/tkonline/taikangtrack/data/recomden_evalute_mPB");
        //非自有平台的from_id
        DataFrame feiZiyou = getFeiZiYouOtherPolicyData(sqlContext);
        saveAsParquet(feiZiyou,"/user/tkonline/taikangtrack/data/recomden_evalute_other_feiziyou"+sysDate);
...
//        saveAsParquet(dfDetail,"/user/tkonline/taikangtrack_test/data/recomden_evalute_dfDetail");
        ...
        /*只跑一次,找回以前的保费
        //自有平台的推荐与非推荐保单  ,
        DataFrame ziyou = getZiYouOtherPolicyData(sqlContext);
        saveAsParquet(ziyou,"/user/tkonline/taikangtrack/data/recomden_evalute_other_ziyou");
        //other推荐和非推 用户行为对应保单表 合并后，把它转化为详情表
        DataFrame dfOtherDetail=getUserBrowserPolicyDetail(sqlContext, "ziYouOtherPolicyData", "UserBrowserOtherPolicyDetail");
        saveAsParquet(dfOtherDetail,"/user/tkonline/taikangtrack/data/recomden_evalute_find_detail");*/

        return dfDetail;
    }

    private DataFrame getFeiZiYouOtherPolicyData(HiveContext sqlContext) {
                String sql="select other.user_id,other.member_id,other.open_id,other.customer_id,other.lrt_id,other.product_name,case when find.platform='微信' then '0' when find.platform='WAP' then '1' when find.platform='PC' then '2' when find.platform='APP' then '3'  else '4' end as info_type,other.lia_policyno,other.lia_accepttime,other.visit_time,other.is_recomend,other.insuranceType,other.premium,other.from_id,find.name " +
                        " from  tknwdb.handle_client find  inner join mergeOthereRecomendAndNonRecomendUP other  on other.from_id = find.from_id where find.platform <> '微信' and find.platform <> 'WAP' and find.platform <> 'PC' and find.platform <> 'APP' ";
        return DataFrameUtil.getDataFrame(sqlContext, sql, "feiZiYouOtherPolicyData");
    }

    private DataFrame getZiYouOtherPolicyData(HiveContext sqlContext) {
        String sql="select other.user_id,other.member_id,other.open_id,other.customer_id,other.lrt_id,other.product_name,case when plat.platform='微信' then '0' when plat.platform='WAP' then '1' when plat.platform='PC' then '2' when plat.platform='APP' then '3'  else '4' end as info_type,other.lia_policyno,other.lia_accepttime,other.visit_time,other.is_recomend,other.insuranceType,other.premium,other.from_id \n" +
                " from tknwdb.handle_client plat inner join mergeOthereRecomendAndNonRecomendUP other  on other.from_id = plat.from_id where plat.platform='微信' or plat.platform='WAP' or plat.platform='PC' or plat.platform='APP' ";
        return DataFrameUtil.getDataFrame(sqlContext, sql, "ziYouOtherPolicyData");
    }
...
//        saveAsParquet(dfM,"/user/tkonline/taikangtrack_test/data/recomden_evalute_final_mer");
    ...
    private DataFrame MergeRecomendAndNonRecomendUP(HiveContext sqlContext){
        String sql="select user_id,member_id,open_id,customer_id,lrt_id,product_name,lia_policyno,lia_accepttime,visit_time,is_recomend,info_type,insuranceType,premium " +
                " from EarliestPolicyResult " +
                " union all " +
                " select user_id,member_id,open_id,customer_id,lrt_id,product_name,lia_policyno,lia_accepttime,visit_time,is_recomend,info_type,insuranceType,premium  " +
                " from NonEarliestPolicyResult ";
        return DataFrameUtil.getDataFrame(sqlContext, sql, "MergeRecomendAndNonRecomendUP", DataFrameUtil.CACHETABLE_EAGER);
    }
