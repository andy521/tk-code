 ...
 * @date   2016年5月7日
 */
public class FactStatisticsEventWithAnony implements Serializable {
    /**
     *
     */
    private static final long serialVersionUID = -2659119974483606462L;
    /**
     *
     */
     ...
     */
    public FactStatisticsEventWithAnony(String rOWKEY, String teriminal_id,String uSER_ID, String aPP_TYPE, String aPP_ID, String eVENT,
    ...
    public FactStatisticsEventWithAnony() {
    }
}
