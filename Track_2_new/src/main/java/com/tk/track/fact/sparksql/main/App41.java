...
public class App41 {
	...
	public static void main(String[] args) {
		...
		SparkConf conf = new SparkConf().setAppName("Taikang Track wechat free healthcheck ETL App41");
		...
		String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "wechat.free.health.check");
		
	    App.loadWchatFreeHealthCheck(sqlContext,appids);
