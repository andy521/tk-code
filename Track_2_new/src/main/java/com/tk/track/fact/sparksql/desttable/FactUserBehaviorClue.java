...
/**
 * @ClassName: FactUserBehaviorClue
 * @Description: 用户行为线索
 * @author langxb
 * @date   2016年9月20日 
 */
public class FactUserBehaviorClue implements Serializable {
	...
	public FactUserBehaviorClue(String ROWKEY, String USER_ID,
			String USER_TYPE, String APP_TYPE, String APP_ID,
			String EVENT_TYPE, String EVENT, String SUB_TYPE,
			String VISIT_DURATION, String FROM_ID, String PAGE_TYPE,
			String FIRST_LEVEL, String SECOND_LEVEL, String THIRD_LEVEL,
			String FOURTH_LEVEL, String VISIT_TIME, String VISIT_COUNT,
			String CLUE_TYPE, String REMARK, String USER_NAME) {
		this.ROWKEY = ROWKEY;
