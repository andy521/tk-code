...
public class App40 {
	...
	public static void main(String[] args) {
		...
		SparkConf conf = new SparkConf().setAppName("Taikang Track count premium ETL APP40");
		...
		String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "wechat.count.premium");
		
	    App.loadUserBehaviorCountPremium(sqlContext,appids);
