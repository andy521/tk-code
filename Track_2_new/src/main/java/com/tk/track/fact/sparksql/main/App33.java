...
public class App33 {
	...
	public static void main(String[] args) {
		...
		SparkConf conf = new SparkConf().setAppName("Taikang Track car insurance ETL APP33");
		...
		String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "car.appids");
		
	    App.loadUserBehaviorBrowseCar(sqlContext,appids);
