...
public class App19 {
	...
	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("Taikang Track FACT_USER_BEHAVIOR_TELE_ACCOUNT_WORTH_MOBILE_APP ETL APP19");
	    ...
	    String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "account_worth_search");
	    System.out.println("=============appids====================" + appids);
	    App.loadFactUserBehaviorClueMobileAccountWorthSearch(sqlContext, appids);
