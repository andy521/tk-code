...
public class App4 {
	...
	public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("Taikang Track FACT_USER_BEHAVIOR_TELE_WEBSITEACT ETL APP4");
        ...
        String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "webSite.act");
        App.loadFactUserBehaviorTeleWebsiteAct(sqlContext, appids);
