...
public class FactSrcUserEvent implements Serializable, Cloneable {
     ...
     * @param cLIENTTIME
     */
    public FactSrcUserEvent(String rOWKEY, String iP, String tIME, String aPP_TYPE, String aPP_ID, String uSER_ID,
            String pAGE, String eVENT, String sUBTYPE, String lABEL, String cUSTOM_VAL, String rEFER, String cURRENTURL,
            String bROWSER, String sYSINFO, String tERMINAL_ID, String dURATION, String cLIENTTIME,String fROM_ID) {
        super();
        ROWKEY = rOWKEY;
        IP = iP;
        TIME = tIME;
    ...
    public String toString() {
        return "FactSrcUserEvent [ROWKEY=" + ROWKEY + ", IP=" + IP + ", TIME=" + TIME + ", APP_TYPE=" + APP_TYPE
