...
public class App34 {
    ...
    public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("Taikang Track fourth month activities accident ETL APP34");
        ...
        String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "act.month4.acci.appids");
        App.loadUserBehaviorActivityAcciMonth4(sqlContext, appids);
