...
public class App6 {
	...
	public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("Taikang Track FACT_USER_BEHAVIOR_TELE_WAPMALL ETL APP6");
        ...
        String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "wap.mall");
        App.loadFactUserBehaviorTeleWap(sqlContext, appids);
