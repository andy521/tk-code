 ...
 * @date
 */
public class UserBehaviorCountPremium  implements Serializable{
...
//        return df;
	    ...
	    public DataFrame getUserBehaviorCuleDF3(HiveContext sqlContext) {
	        String hql = "SELECT T5.ROWKEY,"
	        		...
	        		+"              NVL(T5.VISIT_COUNT, ' '),"
	        		+"              '\073访问时长：',        "
	        		+"              NVL(T5.VISIT_DURATION, ' '),"
	        		+"              '\073其他信息：',        "
	        		+"              NVL(T5.LABEL,' ' )) AS REMARK"
