 ...
 * @date   
 */
public class FactUserBehaviorClueScode implements Serializable {
	...
	public FactUserBehaviorClueScode(String ROWKEY, String USER_ID,
			...
			String CLUE_TYPE, String USER_NAME, String REMARK) {
		this.ROWKEY = ROWKEY;
