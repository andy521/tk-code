...
public class App35 {
	...
	public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("Taikang Track WECHAT_INSURE_FLOW ETL APP35");
        ...
        String appids = TK_CommonConfig.getConfigValue(CONFIG_PATH, "wechat.insureflow");
        App.loadFactUserBehaviorTeleWechatInsureflow(sqlContext, appids);
